<?php require "require.php"; head("Connexion"); require "menu.php"; 
$alert = $email = null;
    ...
    <div class="section">
        ...
        <h2 class="header">Connexion ou Création de compte</h2>
            ...
            <div class="col s6">              
                ...
                <p>En vous inscrivant sur le site vous pourrez ajouter de nouvelles photos ainsi que de nouveaux évènements.</p>
