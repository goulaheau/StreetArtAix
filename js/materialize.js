...
Vel = $ ? $.Velocity : Velocity, function (a) {
    a.fn.collapsible = function (b) {
        ...
        return b = a.extend(c, b), this.each(function () {
            function c(a) {
                f = e.find("> li > .collapsible-header"), a.parent().toggleClass("active"), a.parent().hasClass("active") ? a.siblings(".collapsible-body").stop(!0, !1).slideDown({
                    duration: 350,
                    easing: "easeOutQuart",
                    queue: !1
            ...
            var e = a(this), f = a(this).find("> li > .collapsible-header"), g = e.data("collapsible");
            e.off("click.collapse", ".collapsible-header"), f.off("click.collapse"), b.accordion || "accordion" == g || void 0 == g ? (e.find("> li > .collapsible-header").on("click.collapse", function (b) {
                c(a(b.target))
    ...
    a.fn.scrollTo = function (b) {
        ...
        b = a.extend(c, b), this.each(function () {
            function c() {
                void 0 != g.data("induration") && (b.inDuration = g.data("inDuration")), void 0 != g.data("outduration") && (b.outDuration = g.data("outDuration")), void 0 != g.data("constrainwidth") && (b.constrain_width = g.data("constrainwidth")), void 0 != g.data("hover") && (b.hover = g.data("hover")), void 0 != g.data("gutter") && (b.gutter = g.data("gutter")), void 0 != g.data("beloworigin") && (b.belowOrigin = g.data("beloworigin"))
            }
            ...
            function d() {
                ...
                var f = g.offset().left, j = 0, k = b.gutter;
                f + h.innerWidth() > a(window).width() && (j = g.innerWidth() - h.innerWidth(), k = -1 * k), h.css(e(g[0]) ? {
                    display: "block",
                    position: "fixed",
                    height: 0,
                    top: g.offset().top - a(window).scrollTop() + d,
                    left: g.offset().left + j + k
                } : {
                    display: "block",
                    top: g.offset().top + d,
                    left: g.offset().left + j + k,
    ...
    a.fn.extend({
        openModal: function (b) {
            ...
            b = a.extend(e, b), b.dismissible && (a("#lean-overlay").click(function () {
                ...
                queue: !1,
                ease: "easeOutCubic"
            }), a(c).hasClass("bottom-sheet") ? (console.log("Bottom"), a(c).velocity({
                bottom: "0",
                opacity: 1
            }, {
    ...
    function e(a) {
        ...
        b.classList.add("toast"), c && b.classList.add(c), b.innerHTML = a;
        var e = new Hammer(b, {prevent_default: !1});
        return e.on("pan", function (a) {
            var c = a.deltaX, d = 80;
    ...
    a.scrollSpy = function (b, d) {
        ...
        b = a(b), b.each(function (b, c) {
            g.push(a(c)), a(c).data("scrollSpy:id", b), a("a[href=#" + a(c).attr("id") + "]").click(function (b) {
                ...
                a("html, body").animate({scrollTop: c - 200}, {duration: 400, easing: "easeOutCubic"})
            })
    ...
    a(document).ready(function () {
        ...
        a("input[autofocus]").siblings("label, i").addClass("active"), a(document).on("change", c, function () {
            ...
            a(b.target).is("form") && (a(this).find(c).removeClass("valid").removeClass("invalid"), a(this).find("select.initialized").each(function () {
        ...
        a(this).each(function () {
            if ($select = a(this), !$select.hasClass("browser-default")) {
                ...
                c && ($select.parent().find("i").remove(), $select.parent().find("input").remove(), $select.unwrap(), a("ul#select-options-" + c).remove());
                var d = Materialize.guid();
                $select.data("select-id", d);
                var e = a('<div class="select-wrapper"></div>'), f = a('<ul id="select-options-' + d + '" class="dropdown-content select-dropdown"></ul>'), g = $select.children("option");
                ...
                $select.before(j), j.before(i), a("body").append(f), $select.is(":disabled") || j.dropdown({hover: !1}), $select.addClass("initialized"), j.on("focus", function () {
